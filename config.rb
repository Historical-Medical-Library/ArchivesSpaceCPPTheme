...
##
AppConfig[:db_url] = "jdbc:mysql://127.0.0.1:3306/archivesspace?useUnicode=true&characterEncoding=UTF-8&user=root&password=5S0abzg8TWQV0TN"
##
...
AppConfig[:pui_branding_img] = '/assets/images/WebBannerTransPng.png'
#AppConfig[:pui_block_referrer] = true # patron privacy; blocks full 'referer' when going outside the domain
AppConfig[:pui_enable_staff_link] = false # attempt to add a link back to the staff interface
#
